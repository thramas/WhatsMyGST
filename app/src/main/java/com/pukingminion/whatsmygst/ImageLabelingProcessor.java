...
public class ImageLabelingProcessor extends VisionProcessorBase<List<FirebaseVisionLabel>> {
    ...
    private OnClassifiedListener onClassifiedListener;

    public ImageLabelingProcessor(OnClassifiedListener onClassifiedListener) {
        this.onClassifiedListener = onClassifiedListener;
